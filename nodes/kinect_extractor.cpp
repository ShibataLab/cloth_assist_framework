// kinect_extractor.cpp: Program to read rosbag files and process kinect2 data
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "kinect_extractor", ros::init_options::AnonymousName);
  ...
  // default values of parameters for extractor class
  ...
  Extractor extractor(fileName, topicColor, topicDepth, topicCameraInfo,
                      topicType, videoMode, cloudMode, calibrateMode);

  // run the extractor class to parse rosbag file and get results
  extractor.run();
